...
inline constexpr float antSize = 0.1f;
inline constexpr float grabRange = 0.1f;
inline constexpr float macguffinSize = 2.f;
inline constexpr float movableObjectSize = 1.f;
inline constexpr float goalSize = 1.5f;
