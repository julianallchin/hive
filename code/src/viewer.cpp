...
int main(int argc, char *argv[])
{
    ...
    // Position camera at front of scene, elevated and back a bit to see more of the scene
    float camera_height = (madEscape::consts::worldLength + madEscape::consts::worldWidth) / 4.f;
    math::Vector3 initial_camera_position = { 
        0, // x - centered horizontally
        -madEscape::consts::worldLength * 0.75f, // y - in front of the scene
        camera_height // z - elevated above the scene
    };

    // Rotate to look toward center of scene at a 45 degree downward angle
    math::Quat initial_camera_rotation =
        (math::Quat::angleAxis(0.f, math::up) * // No rotation around vertical axis
        math::Quat::angleAxis(-math::pi / 4.f, math::right)).normalize(); // 45 degree downward tilt
